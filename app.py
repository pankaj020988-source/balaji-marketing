...
# 🔐 मेमरीमध्ये पासवर्ड साठवणे (डिफॉल्ट पासवर्ड: Balaji@123)
if "owner_password" not in st.session_state:
    st.session_state.owner_password = "Balaji@123"
...
# ==========================================
# ⚙️ ४. गुप्त ओनर कंट्रोल पॅनेल (जाहिराती आणि पासवर्ड कंट्रोल)
# ==========================================
with st.expander("⚙️ सायबर ओनर कंट्रोल पॅनेल (लपविलेले विभाग)"):
    ...
    if secret_pass == st.session_state.owner_password:
        ...
        with col_pass2:
            ...
            if st.button("💾 नवीन पासवर्ड कायमचा सेव्ह करा", type="secondary"):
                if new_secure_password.strip() != "":
                    ...
                    st.success(f"✅ पासवर्ड यशस्वीरित्या बदलला आहे! आता नवीन पासवर्ड '{new_secure_password}' हा असेल.")
                    st.rerun()
                else:
        ...
        st.error("❌ चुकीचा पासवर्ड! कृपया योग्य मॅनेजर संकेतशब्द प्रविष्ट करा.")
