...
# 🎯 फॉन्ट दुरुस्ती आणि "मोफत" शब्द काढून अपडेट केलेले ३ मुख्य टॅब्स 🎯
main_tab1, main_tab2, main_tab3 = st.tabs([
    "🔥 महाभरती व लाईव्ह अपडेट्स (Live Offers)", 
    "🏛️ डिजिटल ई-सेवा केंद्र (Services)", 
    "⚡ मोबाईल ऑटो-प्रिंट (Instant Print)"
])

# ------------------------------------------
# टॅब १: महाभरती व लाईव्ह अपडेट्स
# ------------------------------------------
with main_tab1:
...
with main_tab2:
    ...
    with col_grid2:
        ...
        <div class="service-card" style="border-left-color: #20c997;">
            ...
            <div class="service-desc">केंद्र व राज्य शासनाच्या सर्व megaभरती, पोलीस, आर्मी, रेल्वे व अर्ज १००% अचूक भरून मिळतील.</div>
        </div>
...
with main_tab3:
    ...
    <div style="text-align: center; margin-top: 20px; padding: 30px; background-color: #f8faff; border-radius: 12px; border: 2px dashed #0056b3;">
        ...
        <p style="font-size: 16px; color: #444; margin-bottom: 25px;">तुमच्या मोबाईलमधील फोटो, दस्तऐवज किंवा PDF फाईल्स थेट दुकानाच्या प्रिंटरवर पाठवण्यासाठी खालील बटनावर क्लिक करा.</p>
    </div>
    """, unsafe_allow_html=True)
