...
# संपूर्ण साईट १००% फुल स्क्रीन रुंदीलासेट करणे आणि मूळ मेनू लपवणे (CSS मॅजिक)
st.markdown("""
    <style>
        .block-container {
...
with col_grid2:
    ...
    <div class="service-card" style="border-left-color: #343a40;">
        <div class="service-title">🎨 - झेरॉक्स (Xerox) व स्कॅनिंग</div>
...
<div style='background-color: #002f6c; color: white; padding: 15px; border-radius: 8px; text-align: center; font-size: 16px; font-weight: bold; box-shadow: 0px 4px 10px rgba(0,0,0,0.15); border: 2px solid #d4af37;'>
    📍 पत्ताः बालाजी कॉम्प्लेक्स, माणगाव, रायगड, Maharashtra | 📞 संपर्क: 8007365051[cite: 1] | 🟢 व्हॉट्सॲप: 8806789013[cite: 1]
</div>
""", unsafe_allow_html=True)
st.write("---")
...
with col_foot1:
    st.markdown("<p style='font-size: 13px; color: #555; margin-top: 10px; font-weight: bold;'>🙏 धन्यवाद ! पुन्हा भेट द्या![cite: 1] | Designed by Balaji Cyber Point, Mangaon</p>", unsafe_allow_html=True)
